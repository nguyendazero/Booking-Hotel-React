    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout className="site-layout">
        <Content style={{ margin: "24px 16px 0", overflow: "initial" }}>
          ...
          >
            <h1>Hotel List</h1>
            {/* Nội dung trang Hotel List sẽ được thêm vào đây */}
            <p>Đây là trang danh sách các khách sạn.</p>
            {/* Nếu bạn có các route con cho trang Hotel List, Outlet sẽ hiển thị chúng */}
            <Outlet />
          </div>
        </Content>
      </Layout>
